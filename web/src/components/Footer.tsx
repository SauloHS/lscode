...
export function Footer() {
  return (
    <footer className="footer">
      <a
        href="https://github.com/SauloHS/lscode"
        target="_blank"
      ...
      <a
        href="https://github.com/SauloHS/lscode/blob/main/LICENSE"
        target="_blank"
        rel="noopener noreferrer"
      ...
      <span className="footer-copyright">Copyright © Saulo Henrique</span>
    </footer>
  );
}
